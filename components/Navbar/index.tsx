...
const Navbar = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      subMenu: ["Berita", "Agenda", "Pengumuman", "Regulasi", "Laporan Kinerja"],
    },
    {
      name: "Layanan",
      path: "/layanan",
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white shadow-md dark:bg-gray-900 z-50">
      ...
      <Link href="/" className="flex items-center">
          <Image src={logoJayaRaya} alt="Logo Jaya Raya DKI Jakarta" width={50} height={50} />
          <Image src={logoDprkp} alt="Logo DPRKP DKI Jakarta" width={50} height={50} />
          <span className="ml-2 text-lg font-bold text-gray-800">DPRKP DKI Jakarta</span>
        </Link>
        {/* Menu Desktop */}
                ...
                >
                  {item.subMenu.map((sub, subIndex) => (
                    <Link
                      ...
                      className="block px-4 py-2 text-xs text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                    >
                      {sub}
                    </Link>
                  ))}
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/login"
            className="flex items-center bg-teal-600 text-white px-4 py-2 rounded-md text-xs hover:bg-teal-700"
          >
