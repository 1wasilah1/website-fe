      ...
      <div className="container mx-auto px-6 lg:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-[inherit]">
          ...
          <div>
            ...
            <p className="mt-2 text-sm">Senin - Jumat <br /> 08:00 - 15:00 WIB</p>
          </div>

          {/* Formulir Kontak */}
          <div>
            <h2 className="text-lg font-semibold">Punya pertanyaan?</h2>
            <p className="mt-2 text-sm">Jangan ragu untuk mengirimkan kami pesan. Kami akan dengan senang hati membantu Anda.</p>
            <form className="mt-4">
        ...
        <div className="border-t border-gray-400 mt-6 pt-4 text-center text-sm">
          <p>Copyright @2025 Dinas Perumahan Rakyat dan Kawasan Permukiman Provinsi DKI Jakarta All rights reserved.          .</p>
        </div>
      </div>
    </footer>
  );
