...
const taxItems = [
  {
    ...
    icon: <Image src={logoJakgo} alt="Logo Jakgo" width={100} height={50} />,
  ...
  },
  {
    ...
    icon: <Image src={logoPpid} alt="Logo PPID" width={100} height={50} />,
    link: "https://ppid.jakarta.go.id/"
  },
  {
    title: "KIP",
    description: "",
    icon: <Image src={logoKip} alt="Logo Kip" width={100} height={50} />,
    link: "https://kip.jakarta.go.id/"
  },
  {
    title: "Satu Data",
    description: "",
    icon: <Image src={logoSatuData} alt="Logo Satu Data" width={100} height={50} />,
    link: "https://data.go.id/"
  },
  {
    title: "Open Data",
    description: "",
    icon: <Image src={logoOpenGoverment} alt="Logo Satu Data" width={100} height={50} />,
    link: "https://ogi.bappenas.go.id/"
  },
  {
    title: "Portal Statistik",
    description: "",
    icon: <Image src={logoStatistik} alt="Logo Portal Statistik" width={100} height={50} />,
  ...
  return (
    <section className="py-4 bg-white">
      <div className="container mx-auto text-center">
        <h2 className="text-2xl font-bold text-blue-900 mb-6">Aplikasi Terkait </h2>
